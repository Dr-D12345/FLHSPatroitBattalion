...
public class Foxtrot2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String platoonName = "Foxtrot Second Platoon";
        content = (TextView) view.findViewById(R.id.Alpha1content);
        title =(TextView) view.findViewById(R.id.Title);
        title.setText(platoonName);
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        final DatabaseReference myRef = database.getReference().child("Foxtrot").child("two").child("text");
        ...
        s6.setChecked( sharedPreferences.getString("F2","").equals("checked"));
