...
public class Foxtrot3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String platoonName = "Foxtrot Third Platoon";
        content = (TextView) view.findViewById(R.id.Alpha1content);
        title =(TextView) view.findViewById(R.id.Title);
        title.setText(platoonName);
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        final DatabaseReference myRef = database.getReference().child("Foxtrot").child("three").child("text");
        ...
        s6.setChecked( sharedPreferences.getString("F3","").equals("checked"));
