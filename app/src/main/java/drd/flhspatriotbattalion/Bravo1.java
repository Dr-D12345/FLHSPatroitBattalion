...
public class Bravo1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final DatabaseReference myRef = database.getReference().child("Bravo").child("one").child("text");
        ...
        s6.setChecked( sharedPreferences.getString("B1","").equals("checked"));
