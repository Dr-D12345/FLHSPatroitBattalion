...
public class Charlie5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String platoonName = "Charlie Fifth Platoon";
        content = (TextView) view.findViewById(R.id.Alpha1content);
        title =(TextView) view.findViewById(R.id.Title);
        title.setText(platoonName);
        FirebaseDatabase database = FirebaseDatabase.getInstance();
       final DatabaseReference myRef = database.getReference().child("Charlie").child("five").child("text");
        ...
        s6.setChecked( sharedPreferences.getString("C5","").equals("checked"));
