...
public class Alpha1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final DatabaseReference myRef = database.getReference().child("Alpha").child("one").child("text");
        ...
        s6.setChecked( sharedPreferences.getString("A1","").equals("checked"));
