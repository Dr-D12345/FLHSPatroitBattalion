...
public class Delta2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final DatabaseReference myRef = database.getReference().child("Delta").child("two").child("text");
        ...
        s6.setChecked( sharedPreferences.getString("D2","").equals("checked"));
